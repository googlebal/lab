...
.LM41:
	...
	movq	%rbx, %rdi
	call	vcprintf@PLT
	.stabn	68,0,94,.LM42-.LFBB4
.LM42:
	leaq	.LC5(%rip), %rdi
	xorl	%eax, %eax
	call	cprintf@PLT
	.stabn	68,0,96,.LM43-.LFBB4
.LM43:
	movq	24(%rsp), %rax
	xorq	%fs:40, %rax
	jne	.L22
